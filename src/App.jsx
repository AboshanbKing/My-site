...
const galleryItems = [
  { src: '/images/My photo.png', alt: 'Aboshanb King portrait' },
  { src: '/images/Aboshanb car.png', alt: 'Aboshanb King beside a car at night' },
  { src: '/images/Aboshanb car edit.png', alt: 'Aboshanb King car edit' },
]
...
function App() {
  ...
  return <div className="site-shell">
    ...
    <footer className="footer section-wrap"><a className="brand-mark" href="#home"><img src="/images/logo.png" alt="Aboshanb King" /></a><p>© 2026 Aboshanb King<br /><span>{t.footer.rights}</span></p><div className="footer-socials">{socialLinks.map((social) => { const Icon = socialIcon[social.icon]; return <button key={social.name} type="button" aria-label={social.name} onClick={() => openExternal(social.url)}><Icon size={17} /></button> })}</div></footer>
